...
export const useModernTouchGestures = ({
  ...
  const { selectedWeeks, setSelectedWeeks, selectionMode, setSelectionMode, isDragging } =
    useSelectionStore()
  ...
  const handleTouchEnd = useCallback(
    ...
    [isMobile, touchStartTime, isLongPress, isDragging, handleMouseUp, triggerHapticFeedback]
  )
