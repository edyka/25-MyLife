...
const AchievementPopup = ({ badge, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className={`fixed bottom-6 right-6 z-50 max-w-sm w-full p-4 rounded-2xl shadow-2xl border ${
    ...
    >
      ...
      <div className="flex-1">
        <h4
          className={`text-xs font-bold uppercase tracking-wider mb-1 ${darkMode ? 'text-slate-400' : 'text-slate-500'}`}
        >
