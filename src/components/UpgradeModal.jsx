        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
                <motion.div
                    ...
                    className={`w-full max-w-5xl my-8 rounded-3xl shadow-2xl border ${darkMode
                        ? "bg-slate-900 border-slate-700"
                        : "bg-white border-slate-200"
                        }`}
                >
                    {/* Header */}
                    <div className={`sticky top-0 z-10 p-6 border-b ${darkMode ? "border-slate-800 bg-slate-900/95" : "border-slate-100 bg-white/95"} backdrop-blur-md flex items-center justify-between rounded-t-3xl`}>
                        <div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`inline-flex p-3 rounded-xl mb-4 w-fit ${
                                        ...
                                        <Icon className={`w-5 h-5 ${isPro || isLife || tier.highlighted ? "text-white" : darkMode ? "text-slate-300" : "text-slate-600"}`} />
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="flex items-baseline gap-2">
                                            {tier.originalPrice && (
                                                <span className={`text-sm line-through ${darkMode ? "text-slate-600" : "text-slate-400"}`}>
                                                    {tier.originalPrice}
                                                </span>
                                            )}
                                    ...
                                    {/* Divider */}
                                    <div className={`h-px w-full mb-4 ${darkMode ? "bg-white/10" : "bg-slate-200"}`} />
