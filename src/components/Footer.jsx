...
const Footer = memo(({ darkMode, onNavigate, isAuthenticated = true }) => {
  ...
  return (
    <footer
      className={`border-t-2 transition-all duration-500 ${
        darkMode ? 'premium-card-dark border-slate-700/30' : 'premium-card border-slate-200/30'
      } backdrop-blur-lg`}
    >
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5 mb-8">
              <div className="relative">
                <div
                  className={`w-12 h-12 bg-gradient-to-br ${theme.iconBg} rounded-3xl shadow-xl ${theme.shadow} flex items-center justify-center group`}
                >
                ...
                <div
                  className={`absolute -bottom-1 -right-1 w-3 h-3 bg-gradient-to-br ${theme.iconBg} rounded-full border-2 border-white shadow-lg animate-pulse`}
                ></div>
              </div>
              <div>
                <h3
                ...
                <p
                  className={`text-caption font-medium ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}
                >
                  Live Vividly
                </p>
              </div>
            ...
            >
              Transform how you visualize your life's journey. Each week matters, each moment
              counts. Make every week intentional with beautiful, meaningful life tracking.
            </p>
            <div
          ...
          <div>
            <h4 className={`text-heading mb-6 ${darkMode ? 'text-slate-100' : 'text-slate-800'}`}>
              Quick Links
            </h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              {socialLinks.map((social, index) => {
                ...
                return (
                  ...
                  >
                    <IconComponent
                      className={`w-6 h-6 ${social.color} group-hover:scale-110 transition-transform duration-300`}
                    />
                  </motion.a>
                )
              })}
                ...
                <div className="flex items-center gap-2 relative">
                  ...
                  {hoveredTheme && (
                    ...
                    >
                      ...
                      {themes.find(t => t.key === hoveredTheme)?.premium &&
                        !hasPremiumThemes &&
                        ' 🔒'}
                    </div>
                  )}
