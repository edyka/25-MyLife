      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className={`${
            ...
            At Viventiva, we believe your personal data belongs to you. We are committed to transparency, 
            security, and giving you control over your information. This policy explains exactly what data 
        ...
        >
          ...
          <p className={`mb-4 ${
            ...
            Viventiva was built with privacy as a core principle. We don't sell your data, we don't track 
            you across the web, and we give you full control over your information. Your life visualization 
            is personal and private, and we're committed to keeping it that way.
          </p>
          <p className={`text-sm ${
