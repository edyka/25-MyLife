...
const About = ({ onBack }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Mood Tracking',
      description:
        'Color-code your weeks with emotions and create custom categories that matter to you.',
    },
    {
      icon: Target,
      title: 'Goal Setting',
    ...
    },
    {
      ...
      title: 'Privacy First',
      description:
        'All your data stays on your device with client-side encryption. No servers, no tracking.',
    },
  ]
  ...
  const philosophy = [
    {
      ...
      description:
        'Understanding the finite nature of time helps us make more intentional choices about how we spend our weeks.',
    },
    {
      icon: Heart,
      title: 'Meaningful Living',
      description:
        "By visualizing life's brevity, we're inspired to prioritize what truly matters and live with greater purpose.",
    },
    {
      icon: Lightbulb,
      title: 'Conscious Reflection',
      description:
        'Regular reflection on our experiences helps us learn, grow, and make better decisions for the future.',
    },
  ]
  ...
  const stats = [
    {
      ...
      description: 'Each square represents one week of life',
    },
    ...
    <div
      className={`min-h-screen transition-all duration-300 ${
        darkMode
          ...
          : `bg-gradient-to-br ${theme.primaryPastel} text-gray-900`
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className={`w-3 h-12 rounded-full bg-gradient-to-b ${theme.primary}`} />
            ...
            >
              A philosophical tool for conscious living that transforms your finite weeks into a
              visual canvas for intentional existence.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className={`p-8 rounded-2xl mb-12 text-center ${
            darkMode
              ? `bg-gradient-to-r ${theme.primaryFaded} border ${theme.accentBorder500_20}`
              : `bg-gradient-to-r ${theme.primaryLight} border ${theme.accentBorder200}`
          }`}
        >
          <Quote
            className={`w-12 h-12 mx-auto mb-4 ${
              darkMode
                ? theme.accentDark.replace('text-', 'text-')
                : theme.accent.replace('text-', 'text-')
            }`}
          />
          <blockquote
            className={`text-2xl font-medium mb-4 italic ${
                ...
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
                      darkMode ? theme.accentBgDark : theme.accentBg
                    }`}
                  >
                    <IconComponent
                      className={`w-8 h-8 ${
        ...
        <motion.div
          ...
          className={`text-center p-8 rounded-2xl ${
            darkMode
              ? `bg-gradient-to-r ${theme.tertiaryFaded} border ${theme.accentBorder500_20}`
              : `bg-gradient-to-r ${theme.tertiaryLight} border ${theme.accentBorder200}`
          }`}
        >
          <Star
            className={`w-12 h-12 mx-auto mb-4 ${
