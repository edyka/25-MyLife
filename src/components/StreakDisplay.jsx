...
const StreakDisplay = () => {
    ...
    return (
        <div className="relative">
            <motion.div
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border ${darkMode
            ...
            >
                ...
                >
                    <Flame className={`w-4 h-4 ${showCelebration ? "fill-orange-500" : "fill-orange-500/20"}`} />
                </motion.div>
