      ...
      <div className="mt-8 mx-auto w-full max-w-6xl px-4">
        <div className="space-y-8">
          ...
          <div className="text-center mb-8">
            <h2
              className={`text-3xl font-black bg-gradient-to-r ${themePreset ? theme.primary : 'from-emerald-500 to-teal-600'} bg-clip-text text-transparent mb-2`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className={`p-6 rounded-2xl ${darkMode ? 'premium-card-dark' : 'premium-card'}`}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <span
                    className={`block text-sm font-medium mb-3 ${darkMode ? 'text-slate-300' : 'text-slate-700'}`}
                  >
                    Display Mode
                  </span>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      >
                        <div
                          className={`h-8 rounded-lg bg-gradient-to-r ${t.preview} mb-2 ${themePreset === t.key ? 'ring-2 ring-white/50' : ''}`}
                        />
