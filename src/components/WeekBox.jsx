...
const WeekBox = memo(
  ({
    ...
    const weekState = useMemo(() => {
      ...
      const isWeekSelected = (isSelected && isSelected(weekNum)) || selectedWeeks.has(weekNum)
    ...
    return (
      <div
        className={`${sizeClass} week-square cursor-pointer relative select-none ${bgColor} ${
          ...
          isWeekSelected && !isBeingDragged ? 'ring-2 ring-purple-500 shadow-md' : ''
        } ${isWeekInPreview ? 'ring-2 ring-blue-400 ring-opacity-60' : ''} ${
          isInMultiSelectMode ? 'ring-1 ring-gray-400 ring-opacity-50' : ''
        } ${
          shouldShowHoverEffect
            ? 'hover:scale-110 hover:z-10 hover:shadow-[0_0_12px_rgba(59,130,246,0.5)] hover:ring-2 hover:ring-blue-400/50'
            : ''
      ...
      >
        ...
        {hasMilestone && (
          <div className="absolute top-0 right-0 pointer-events-none">
            <div
              ...
              style={{
                borderTopColor: hasMilestone.isMilestone
                  ? colorMap[allCategories[hasMilestone.category]?.color] || '#facc15'
        ...
        {hasMilestone?.isMilestone && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div
              className="w-1.5 h-1.5 rotate-45 shadow-sm border-[0.5px]"
              style={{
                backgroundColor: colorMap[allCategories[hasMilestone.category]?.color] || '#facc15',
