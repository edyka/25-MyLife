      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className={`text-lg leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            These terms govern your use of Viventiva, a life visualization application designed to
            help you reflect on time and live more intentionally.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            Viventiva deals with themes of mortality and time awareness. While designed to inspire
            intentional living, some users may find these concepts emotionally challenging. Please
            use the application mindfully and seek professional support if you experience distress.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <Heart className={`w-6 h-6 ${darkMode ? 'text-green-400' : 'text-green-600'}`} />
            <h3 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              Our Commitment
            </h3>
          </div>
          <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            Viventiva was created with the intention of helping people live more meaningful,
            intentional lives. We are committed to keeping the application free, privacy-focused,
            and true to its philosophical foundations.
          </p>
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
