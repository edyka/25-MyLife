...
class ToastManager {
  ...
  init() {
    ...
    if (!this.container) {
      ...
      this.container.className =
        'fixed top-4 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none'
  ...
  show(message, type = 'info', duration = 5000) {
    ...
    root.render(
      <ToastNotification message={message} type={type} duration={duration} onClose={handleClose} />
    )
