...
export const getUserFriendlyError = error => {
  ...
  const errorMessages = {
    ...
    [ERROR_TYPES.BROWSER_BLOCKING]:
      'Your browser is blocking this request. Please disable Brave Shields or similar privacy extensions.',
  ...
  getUserProfile: async userId => {
    ...
    try {
      ...
      if (error && error.status === 406) {
        console.error(
          '[Viventiva] Brave Shields is blocking Supabase requests (406). Please disable Shields for localhost.'
        )
      }
